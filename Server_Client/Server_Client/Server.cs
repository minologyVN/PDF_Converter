    ...
    class Server
    {
        ...
        public class HandleClient
        {
            ...
            public static string ToWordDOCX(string fileUp)
            {
                ...
                string docName = filePath.Substring(0, filePath.Length - 4) + ".docx"; // c?t .pdf hoac .txt r?i thêm duôi .docx
            ...
            public static string ToWordDoc(string fileUp)
            {
                ...
                {
                    docName = filePath.Substring(0, filePath.Length - 5) + ".doc";
                }
                else { docName = filePath.Substring(0, filePath.Length - 4) + ".doc"; }
                if (fileUp.Contains(".pdf"))
                {
                    PDDocument doc = PDDocument.load(fileUp);
                    PDFTextStripper stripper = new PDFTextStripper();
            ...
            public static string ToText(string fileUp)
            {
                ...
                if (fileUp.Contains(".docx"))
                {
                    docName = filePath.Substring(0, filePath.Length - 5) + ".txt";
                }
                else { docName = filePath.Substring(0, filePath.Length - 4) + ".txt"; }
                if (fileUp.Contains(".pdf"))
                {
                    PDDocument doc = PDDocument.load(fileUp);
                    PDFTextStripper stripper = new PDFTextStripper();
            ...
            public static string ToPDF(string fileUp)
            {
                ...
                if (fileUp.Contains(".docx"))
                {
                    docName = filePath.Substring(0, filePath.Length - 5) + ".pdf";
                }
                else { docName = filePath.Substring(0, filePath.Length - 4) + ".pdf"; }
